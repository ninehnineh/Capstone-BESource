...
namespace Parking.FindingSlotManagement.Infrastructure.Persistences
{
    public class ParkZDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //        .HasConstraintName("FK__TimeLines__Traff__412EB0B6");

            //    entity.HasOne(x => x.ParkingPrice)
            //        .WithMany(x => x.TimeLines)
            //        .HasForeignKey(x => x.ParkingPriceId)
            //        .HasConstraintName("FK__TimeLines__ParkingP");
            //});
            ...
            //        .HasForeignKey(d => d.ParkingId)
            //        .HasConstraintName("FK__ParkingHa__Parki");

            //    //entity.HasOne(d => d.ParkingPrice)
            //    //    .WithMany(p => p.ParkingHasPrices)
            //    //    .HasForeignKey(d => d.ParkingPriceId)
            //    //    .HasConstraintName("FK__ParkingHas__ParkiPri");
            //});
