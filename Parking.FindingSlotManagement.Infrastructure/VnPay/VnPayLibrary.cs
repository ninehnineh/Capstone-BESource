...
namespace Parking.FindingSlotManagement.Infrastructure.VnPay
{
    public class VnPayLibrary
    {
        ...
        public PaymentResponseModel GetFullResponseData(IQueryCollection collection, string hashSecret)
        {
            ...
            var vnpMessage = vnPay.GetResponseData("vnp_Message");
            ...
            return new PaymentResponseModel()
            {
                ...
                VnPay_Message = vnpMessage,
                VnPay_TransactionNo = vnpTransactionNo,
                VnPay_TransactionStatus = vnpTransactionStatus,
                TmnCodeForSpot = tmnCode
            };
        }
