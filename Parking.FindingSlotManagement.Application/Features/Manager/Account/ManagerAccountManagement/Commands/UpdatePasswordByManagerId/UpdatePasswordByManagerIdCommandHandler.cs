...
{
    public class UpdatePasswordByManagerIdCommandHandler : IRequestHandler<UpdatePasswordByManagerIdCommand, ServiceResponse<string>>
    {
        private readonly IAccountRepository _accountRepository;

        public UpdatePasswordByManagerIdCommandHandler(IAccountRepository accountRepository)
        {
            _accountRepository = accountRepository;
        }
        public async Task<ServiceResponse<string>> Handle(UpdatePasswordByManagerIdCommand request, CancellationToken cancellationToken)
        {
            try
            {
