...
{
    public class AcceptRequestRegisterAccountCommandHandlerTests
    {
        private readonly Mock<IAccountRepository> _mockAccountRepository;
        private readonly AcceptRequestRegisterAccountCommandHandler _handler;
        private readonly Mock<IEmailService> _emailServiceMock;
        public AcceptRequestRegisterAccountCommandHandlerTests()
        {
            _emailServiceMock = new Mock<IEmailService>();
            _mockAccountRepository = new Mock<IAccountRepository>();
            _handler = new AcceptRequestRegisterAccountCommandHandler(_mockAccountRepository.Object, _emailServiceMock.Object);
        }
        [Fact]
        public async Task Handle_WithValidRequest_ShouldReturnSuccessResponse()
        {
            ...
            var request = new AcceptRequestRegisterAccountCommand { UserId = userId };
