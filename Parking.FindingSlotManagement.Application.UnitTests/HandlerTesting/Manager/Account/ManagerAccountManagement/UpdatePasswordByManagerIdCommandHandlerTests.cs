...
namespace Parking.FindingSlotManagement.Application.UnitTests.HandlerTesting.Manager.Account.ManagerAccountManagement
{
    public class UpdatePasswordByManagerIdCommandHandlerTests
    {
        private readonly Mock<IAccountRepository> _accountRepositoryMock;
        private readonly UpdatePasswordByManagerIdCommandValidation _validator;
        private readonly UpdatePasswordByManagerIdCommandHandler _handler;
        public UpdatePasswordByManagerIdCommandHandlerTests()
        {
            _accountRepositoryMock = new Mock<IAccountRepository>();
            _validator = new UpdatePasswordByManagerIdCommandValidation();
            _handler = new UpdatePasswordByManagerIdCommandHandler(_accountRepositoryMock.Object);
        }
        ...
        public async Task Handle_WhenUpdateSuccessful_ReturnsSuccess()
        {
            ...
            var command = new UpdatePasswordByManagerIdCommand { ManagerId = 1, OldPassword = "oldpassword", NewPassword = "newpassword" };
        ...
        public async Task Handle_WhenManagerNotFound_ReturnsError()
        {
            ...
            var command = new UpdatePasswordByManagerIdCommand { ManagerId = 1 };
            ...
            response.Message.ShouldBe("Không tìm thấy quản lý.");
        }
        [Fact]
        public async Task Handle_WhenOldPasswordIncorrect_ReturnsError()
        {
            ...
            var command = new UpdatePasswordByManagerIdCommand { ManagerId = 1, OldPassword = "wrongpassword", NewPassword = "newpassword" };
        ...
        {
            var command = new UpdatePasswordByManagerIdCommand
            {
                ManagerId = 1,
                OldPassword = "",
